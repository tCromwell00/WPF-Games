    ...
    public class PlayingCard: ViewModel
    {
        public CardSuit Suit
        {
            get
            {
                ...
                if (enumVal < 13) return CardSuit.Hearts;
                if (enumVal < 26) return CardSuit.Diamonds;
                if (enumVal < 39) return CardSuit.Clubs;
        ...
        /// </summary>
        private NotifyingProperty CardTypeProperty = new NotifyingProperty("CardType", typeof(CardType), CardType.SA);
